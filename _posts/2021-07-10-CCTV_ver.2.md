...
# 가상 데이터 생성
> 데이터를 생성할 시작시간/ 종료시간을 지정하면 5분간격으로 데이터 생성하여 DB에 업로드   
<br />
...
```sql
mysql> SELECT * FROM test ORDER BY start_date DESC limit 10;
+-------+---------------------+---------------------+--------+---------+
...
| 21710 | 2021-07-10 18:26:07 | 2021-07-10 18:31:07 |      1 |       4 |
| 21709 | 2021-07-10 18:15:00 | 2021-07-10 18:20:00 |      6 |       3 |
| 21708 | 2021-07-09 18:06:24 | 2021-07-09 18:11:24 |      1 |       4 |
| 21707 | 2021-07-07 18:35:00 | 2021-07-07 18:40:00 |      4 |       0 |
| 21706 | 2021-07-07 16:31:28 | 2021-07-07 16:36:28 |      5 |       3 |
+-------+---------------------+---------------------+--------+---------+
