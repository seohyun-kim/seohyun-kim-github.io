...
mysql> DESC car_speed; # 스피드 관련 테이블 모두 동일 (float 형)
+-----------+-----------+------+-----+---------+-------+
| Field     | Type      | Null | Key | Default | Extra |
+-----------+-----------+------+-----+---------+-------+
| rid       | int       | NO   | MUL | NULL    |       |
| date_time | timestamp | YES  |     | NULL    |       |
| cor_0     | float     | YES  |     | NULL    |       |
| cor_1     | float     | YES  |     | NULL    |       |
| cor_2     | float     | YES  |     | NULL    |       |
| cor_3     | float     | YES  |     | NULL    |       |
| cor_4     | float     | YES  |     | NULL    |       |
| cor_5     | float     | YES  |     | NULL    |       |
| cor_6     | float     | YES  |     | NULL    |       |
| cor_7     | float     | YES  |     | NULL    |       |
| cor_8     | float     | YES  |     | NULL    |       |
+-----------+-----------+------+-----+---------+-------+
11 rows in set (0.01 sec)
```
<details>
