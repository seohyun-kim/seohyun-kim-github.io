...
| people_pos             | json     | YES  |     | NULL    |       |
| car_speed              | json     | YES  |     | NULL    |       |
| truck_speed            | json     | YES  |     | NULL    |       |
| bus_speed              | json     | YES  |     | NULL    |       |
| motorcycle_speed       | json     | YES  |     | NULL    |       |
| electric_scooter_speed | json     | YES  |     | NULL    |       |
+------------------------+----------+------+-----+---------+-------+
